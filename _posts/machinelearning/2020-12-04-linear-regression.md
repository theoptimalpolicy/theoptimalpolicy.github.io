...
$$
w_0+w_1\cdot\left(\text{dimension in }m^2\right) \simeq\text{Price in \$}
$$
...
![](../../../../Projects/Github/TheOptimalPolicy/theoptimalpolicy/markdowns/LinearRegression/LinearRegressionMedia/videos/param_space.mp4)
